...
use App\Filament\Resources\FranceUpcomingResource\Pages;
...
class FranceUpcomingResource extends Resource
{
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('teacher.name')
                    ...
                    ->getStateUsing(function ($record) {
                        $t = $record->teacher;
                        $name = $t ? trim((string) ($t->name ?? '')) : '';
                        return $name !== '' ? $name : (($t->email ?? null) ?: '—');
                    })
                    ->badge()
                    ->sortable(),
                ...
                Tables\Filters\SelectFilter::make('calendar')
                    ...
                    ->options(function () {
                        ...
                        $cals = DB::table('class_sessions')
                            ...
                            ->whereRaw('LOWER(location) = ?', ['france'])
    ...
    {
        return [
            'index' => Pages\ListFranceUpcoming::route('/'),
        ];
    }
}
